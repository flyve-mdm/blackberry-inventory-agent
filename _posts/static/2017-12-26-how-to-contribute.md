...
You can help us to make [Inventory Agent for Blackberry](https://github.com/flyve-mdm/blackberry-inventory-agent/) becomes better and better by contributing to the project on GitHub.
